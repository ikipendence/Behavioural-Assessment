...
const questions = [
  ...
  { id: 'wfh', label: '10. Are you comfortable working from home for 5 days a week?', type: 'radio', options: ['Yes', 'No'], required: true },
  { id: 'unpaid', label: '11. Why do you want to join this internship when it is unpaid?', type: 'textarea', required: true },
  { id: 'expectations', label: '12. What are your expectations from this internship in terms of your own gains considering ikipendence is an early-stage startup?', type: 'textarea', required: true },
