...
const questions = [
  ...
  { id: 'wfh', label: '10. Are you comfortable working from home for 5 days a week (8 hours/day & flexible timings)?', type: 'radio', options: ['Yes', 'No'], required: true },
  { id: 'unpaid', label: '11. Why do you want to join this internship when it is unpaid?', type: 'textarea', required: true },
  { id: 'expectations', label: '12. What makes you passionate about the role of a Business Growth Intern?', type: 'textarea', required: true },
